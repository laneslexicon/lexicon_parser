...
CREATE TABLE links (id integer primary key, linkid integer,orthid text default NULL ,datasource integer,root text,word text,fromnode text,tonode text,link text,matchtype integer,matchedword text,orthfixtype integer default -1,orthpattern text,orthindex integer,status integer default -1,note text);
